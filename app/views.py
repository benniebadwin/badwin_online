...
# subscribe
from app.models import Order,Category,subscriptions
...
def wishlist(request):
    ...
    return render(
        request, "dashboard/user_wishlist.html", {"wishlist": products}
    )
...
def contactus(request):
  ...
  contact = contactus(first_name = first_name, last_name = last_name, email = email, message = message)
  contact.save()
  messages.error(request, "Message Submitted Succesfully")
  return render("/")
